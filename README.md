...
Pelajar memilih kata dasar dan imbuhan, kemudian app menunjukkan:
- Kata terbitan dengan warna berlainan bagi setiap bahagian (awalan / kata dasar / akhiran)
...
| Peringkat | Skop |
|-----------|------|
| Asas | Awalan mudah: ber-, ter-, di-, ke-, se- |
...
| `style.css` | Reka bentuk & animasi |
| `app.js` | Logik pengimbuhan & UI |
| `data.js` | Senarai kata dasar & definisi imbuhan |
